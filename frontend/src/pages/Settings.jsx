...
import { Loader2, Building2, CreditCard, MessageSquare, Clock, Edit2, Eye, Database, CheckCircle, Lock, Calendar, RefreshCw, Link2, Unlink } from 'lucide-react';
                    ...
                    <>
                      ...
                      <div className="border-t border-maya-border pt-6">
                        ...
                        <div className="space-y-4">
                          ...
                          {formData.sms_mode === 'automated' && (formData.send_confirmation_request || formData.send_24h_reminder) && (
                            <div className="mt-3 p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                              <p className="text-sm text-green-700 dark:text-green-300 flex items-center gap-2">
                                <span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span>
                                Automated reminders are active. Messages will be sent automatically at the configured times.
                              </p>
                            </div>
                          )}
                        </div>
